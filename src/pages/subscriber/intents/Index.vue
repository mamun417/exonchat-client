<template>
    <div class="tw-flex tw-flex-col">
        ...
        >
            <q-card style="max-width: 500px">
                ...
                <q-card-section class="q-py-2 tw-mx-6">
                    ...
                    <div class="tw-text-xxs tw-mt-5 tw-text-gray-700">
                        <div>
                            Note: When a msg is parsed by ai it will return the
                            parent intent. Then it will resolve to your intents
                            action or content.
                        </div>
                    </div>
                </q-card-section>
        ...
        <q-dialog
            v-model="editIntentTypeGlobal"
            @update:modelValue="(value) => (editIntentTypeGlobal = value)"
            persistent
        >
