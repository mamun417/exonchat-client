    ...
    <div class="tw-flex tw-flex-col">
        ...
        <div class="tw-flex-grow">
            <div class="tw-shadow-lg tw-bg-white tw-p-4">
                ...
                <div
                    class="tw-text-xxs tw-mt-5 text-grey-8 tw-p-2 tw-font-medium"
                >
                    Note: If a agent is assigned to a department then agent will
                    be prioritized to this department. Else all the department.
                </div>
            </div>
        </div>

        <q-dialog
            v-model="newDepartmentModal"
            @update:modelValue="(value) => (newDepartmentModal = value)"
            persistent
        >
            <q-card style="max-width: 500px">
                ...
                <q-card-section class="q-py-2 tw-mx-6">
                    ...
                    <div
                        class="tw-text-xxs tw-mt-5 bg-orange tw-p-2 tw-text-gray-700"
                    >
                        <div>
                            Note: If you don't select agents then all agents
                            will be assigned to this department
                        </div>
                    </div>
                </q-card-section>
        ...
        <q-dialog
            v-model="editModal"
            @update:modelValue="(value) => (editModal = value)"
            persistent
        >
